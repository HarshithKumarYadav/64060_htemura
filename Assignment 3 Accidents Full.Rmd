---
title: "Assignment 3 Accidents data set"
...
##Objective is to determine if a recently reported accident may result in injuries. (MAX_SEV_IR = 1 or 2) or will not (MAX_SEV_IR = 0). 
...
```{r}
Accidents_Data<- read.csv("C:\\Users\\Harshith Kumar\\Downloads\\accidentsFull.csv")
...
#Make a dummy variable called "INJURY" and add it to the data.
...
```
```{r}
#Calculating the Injury's Probability 
...
```{r}
#make a new subset containing only the necessary records.
...
#For these 24 records, make a pivot table that analyzes INJURY as a function of the two predictors. Use all three variables as rows and columns in the pivot table.
...
#Calculate the exact Bayes conditional probabilities of an injury (INJURY = Yes) given the six potential predictor combinations.


```{r}

#QUESTION4
#ASSESSING THE SIX POSSIBLE COMBINATIONS OF THE PREDITCTORS TO DETERMINE THE BAYES CONDITIONAL PROBABILITIES OF A INJURY (INJURY = YES).
